...
public class StartingRoom extends BaseRoom
{
	...
	public String getStartingMessage()
	{
		return "You're being hunted by the State Security Department of North Korea after having escaped from the " +
			   "Hoeryong concentration camp. With you is your wife and two kids. If you get caught, you will surely " +
			   "be" +
			   ...
			   "Demilitarized Zone is a much greater challenge. Luckily you spot the entrance to a tunnel apparently" +
			   " " +
			   "leading under the Demilitarized Zone. You decide that the tunnel provides a better chance of escape " +
