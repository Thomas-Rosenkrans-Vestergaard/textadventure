...
public class ConsoleUI implements UI {
     ...
     */
    @Override
    public void onCloseDoor(Game game, Door door, Player player) {
     ...
     */
    @Override
    public void onOpenDoor(Game game, Door door, Player player) {
    ...
    @Override
    public void onDoorAlreadyClosed(Game game, Door door, Player player) {
        System.out.println("Door is already closed.");
    }

    @Override
    public void onDoorAlreadyOpen(Game game, Door door, Player player) {
